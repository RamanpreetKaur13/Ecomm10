            ...
            <div class="card-body">
                <div class="row">
                    <x-forms.text-input label="Brand Name" type="text" name="brand_name"
                        ...
                        <x-forms.file-component label="Brand Logo" name="brand_logo" />

                </div>
                <div class="row">
                    <x-forms.text-input label="Url" type="text" name="brand_url"
                        placeholder="Enter url ex:peter-england" />
                    <x-forms.text-input label="Brand Discount" type="number" name="brand_discount"
                        placeholder="Enter brand discount" />
                </div>
                <div class="row">
                    <x-forms.file-component label="Brand Image" name="brand_image" />
                    <x-forms.textarea-component label="Brand Description" name="brand_description" placeholder="Enter brand description" />
                </div>
                <hr>
                <div class="row mt-4">
